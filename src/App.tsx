    ...
    <div className="min-h-screen bg-[#F7F5F3] text-[#20243A] flex flex-col font-sans selection:bg-[#DDD4FF] selection:text-[#553BB8]">
      ...
      {toasts.length > 0 && (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-2 pointer-events-none">
          {toasts.map(t => (
            <div key={t.id} className="pointer-events-auto px-5 py-3 rounded-2xl bg-[#15192C] text-white text-xs sm:text-sm font-semibold shadow-2xl border border-white/20 animate-in slide-in-from-bottom-5 duration-200 flex items-center gap-3">
