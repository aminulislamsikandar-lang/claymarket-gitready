...
export const MessagingDrawer: React.FC = () => {
  ...
  const getCounterpart = (conversation: typeof activeConv) => {
    ...
    if (currentIsBuyer) return { name: conversation.sellerName || conversation.shopName || 'Seller', role: 'Seller', context: conversation.shopName || '', avatar: conversation.shopAvatar || '' };
